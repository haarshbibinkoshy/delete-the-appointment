...
window.addEventListener('DOMContentLoaded',()=>{
    let datas;
    axios.get(`https://crudcrud.com/api/b5a4559a5e614d8e87353a413a410d70/appointmentData`)
    .then(res=>{
...
function addToList(userObj) {
        ...
        deleteBtn.addEventListener(`click`,()=>{
            ...
            axios.delete(`https://crudcrud.com/api/b5a4559a5e614d8e87353a413a410d70/appointmentData/${userObj._id}`)
            console.log(userObj);
            li.remove()
